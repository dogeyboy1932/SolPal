...
export function getServerTools() {
  return [
    ...
    },
    {
      ...
      description: 'Generate AI-powered transaction suggestions based on context and wallet state',
      inputSchema: {
        type: 'object',
        properties: {
          context: {
          ...
          recentActivity: {
            type: 'string',
            description: 'Recent transaction activity or patterns'
          }
        },
        required: []
      }
    },
    {
      ...
      inputSchema: {
        ...
        properties: {
          transactionHistory: {
            type: 'array',
            description: 'Recent transaction data for analysis'
          },
          timeframe: {
            type: 'string',
    ...
    },
    {
      ...
      description: 'Perform intelligent safety checks for transactions',
      inputSchema: {
        type: 'object',
        properties: {
          transactionType: {
            type: 'string',
            enum: ['transfer', 'swap', 'stake', 'unstake', 'governance'],
            description: 'Type of transaction to check'
          },
          recipient: {
            type: 'string',
